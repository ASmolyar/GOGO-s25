    ...
    <>
      <header className={`spotify-header ${isScrolled ? 'scrolled' : ''}`}>
        <div className="header-left">
          ...
          <div className="logo-container">
            <img 
              ...
              alt="Guitars Over Guns" 
              className="header-logo"
              onError={(e) => {
                e.currentTarget.onerror = null;
                e.currentTarget.src = "https://placehold.co/150x40/111/fff?text=Guitars+Over+Guns";
              }}
            />
          </div>
        </div>
        ...
        <div className="header-center">
          <h1 className="header-title">Impact Report</h1>
        </div>
        
        <div className="header-right">
          <button className="spotify-icon-button heart-button">
      ...
      <div className={`side-nav ${menuOpen ? 'open' : ''}`}>
        <nav className="nav-content">
          <div className="nav-section">
            <div className="nav-item active" onClick={() => handleNavItemClick(0)}>
            ...
            <div className="nav-item" onClick={() => handleNavItemClick(1)}>
              <div className="nav-icon">
                <svg viewBox="0 0 24 24" width="24" height="24">
            ...
            <div className="nav-item" onClick={() => handleNavItemClick(3)}>
              <div className="nav-icon">
                <svg viewBox="0 0 24 24" width="24" height="24">
            ...
            <div className="nav-item" onClick={() => handleNavItemClick(2)}>
              <div className="nav-icon">
                <svg viewBox="0 0 24 24" width="24" height="24">
            ...
            <div className="nav-item" onClick={() => handleNavItemClick(4)}>
              <div className="nav-icon">
                <svg viewBox="0 0 24 24" width="24" height="24">
          ...
          <div className="playlist-tracks">
            <h4 style={{ margin: '20px 0 12px', fontSize: '14px', color: 'var(--spotify-light-gray)' }}>
              Student Tracks
            </h4>
            
            <div className="playlist-track" onClick={() => setMenuOpen(false)}>
      ...
      <div className="now-playing-bar">
        ...
        <div className="now-playing-center">
          <div className="playback-controls">
            <button className="spotify-icon-button">
              <svg viewBox="0 0 16 16" width="16" height="16">
            ...
            <button className="playback-button play-pause">
              <svg viewBox="0 0 16 16" width="16" height="16">
        ...
        <div className="now-playing-right">
          <div className="volume-control">
            ...
            <div className="progress-bar-container" style={{width: '100px'}}>
              ...
              <div className="progress-bar-handle" style={{left: '70%'}}></div>
            </div>
          </div>
        </div>
      </div>
