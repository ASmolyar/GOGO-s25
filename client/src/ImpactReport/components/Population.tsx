...
const GraphsContainer = styled.div<{ active: boolean }>`
  ...
  box-shadow: none;
  filter: ${({ active }) => (active ? 'none' : 'grayscale(1) brightness(0.6) opacity(0.3)')};
...
const Population: React.FC = () => {
    ...
    return (
        <Container>
            ...
            <Text white>
                That is why, since 2008, Guitars Over Guns has used the transformative power of music, mentorship, and the arts to unlock possibilities for the young people society is failing to reach.
            </Text>
            ...
            >
                <GraphCard>
                    <PieChartWrapper>
                        <svg width="120" height="120" viewBox="0 0 120 120">
                            {/* Blue slice: 46% */}
                            <path
                                d={getPieSlicePath(60, 60, 56, 0, 165.6)}
                                fill="#7b7fd1"
                            />
                            ...
                            <path
                                d={getPieSlicePath(60, 60, 56, 324, 360)}
                                fill="#b2d8c5"
                            />
                        </svg>
                        <div style={{ display: 'flex', gap: '0.7rem', marginTop: '0.5rem', justifyContent: 'center' }}>
                            <span style={{ display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
                                <span style={{ width: 14, height: 14, background: '#a259d9', borderRadius: '50%', display: 'inline-block' }} />
                                <span style={{ fontSize: '0.95rem', color: '#444' }}>44% Black/African American</span>
                            </span>
                            <span style={{ display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
                                <span style={{ width: 14, height: 14, background: '#7b7fd1', borderRadius: '50%', display: 'inline-block' }} />
                                <span style={{ fontSize: '0.95rem', color: '#444' }}>46% Hispanic/Latinx</span>
                            </span>
                        </div>
                        <PieCaption>
                ...
                <GraphCard>
                    ...
                    <CardLabel>
                        of Guitars Over Guns students made or maintained academic gains in the school year 2023-2024.
                    </CardLabel>
                </GraphCard>
                <GraphCard>
                    <PercentCircle>
                    ...
                    <CardLabel>
                        of Guitars Over Guns students improved conduct in their classes over the course of the school year in 2023-2024.
                    </CardLabel>
                </GraphCard>
            </GraphsContainer>
            <Text>
                <em>Through Guitars Over Guns' programs, youth develop core skills and a support system that are crucial for personal and professional success:</em>
                <SkillsList>
            ...
            <hr style={{ border: 'none', borderTop: '2px solid #b2d8c5', margin: '2rem 0' }} />
            <Text>
            ...
            <SimplePercentsContainer>
                <SimplePercentCard>
                    ...
                    <SimplePercentLabel>2023-24 students scored 81+ on C-GAS</SimplePercentLabel>
                </SimplePercentCard>
                <SimplePercentCard>
                    <SimplePercentValue>100%</SimplePercentValue>
                    <SimplePercentLabel>of GOGO students with initial problems improved 5+ points</SimplePercentLabel>
                </SimplePercentCard>
                <SimplePercentCard>
                    <SimplePercentValue>85%</SimplePercentValue>
                    <SimplePercentLabel>Fall 2023: students increased or maintained C-GAS</SimplePercentLabel>
                </SimplePercentCard>
                <SimplePercentCard>
